...
## نکات:
- این پروژه به صورت بسیار ساده و مینیمال پیاده سازی شده و صرفا برای ارزیابی کیفیت کد زنی قابل استفاده است و برای استفاده در محیط پروداکشن نیاز به اصلاح دارد. (مثلا ارور هندلینگ های شخصی سازی شده برای درخواست های gemini باید پیاده سازه شود، برای سرچ محصولات در فایل rag.py بهتر است از embeding ها استفاده شود و ...)
